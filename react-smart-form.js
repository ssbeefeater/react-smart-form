(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["react-smart-form"] = factory(require("react"));
	else
		root["react-smart-form"] = factory(root["React"]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_is_function__ = __webpack_require__(26);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_hoist_non_react_statics__ = __webpack_require__(27);
...
exports.default = {
    shadesOfGray: ['#212121', '#616161', '#9E9E9E', '#BDBDBD', '#FAFAFA'],
    main: '#448AFF',
    error: '#d50000'
};
...
var smartForm = function smartForm(CustomForm) {
    var SmartForm = function (_Component) {
        ...
        function SmartForm() {
            ...
            var _this = _possibleConstructorReturn(this, (SmartForm.__proto__ || Object.getPrototypeOf(SmartForm)).call(this));
            ...
            _this.hasChange = function () {
                return !(0, _lodash2.default)(_this.state.values, _this.defaultValues);
            };

            _this.setDefaultValues = function () {
                var newValues = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

                _this.defaultValues = Object.assign(_this.defaultValues, newValues);
                return _this;
            };
            ...
            _this.getValues = function (fieldName) {
                return fieldName ? _this.state.values[fieldName] : _this.state.values;
            };

            _this.getErrors = function (fieldName) {
                return fieldName ? _this.state.errors[fieldName] : _this.state.errors;
            };

            _this.hasError = function () {
                var errorKeys = Object.keys(_this.state.errors);
                if (!errorKeys.length) {
                    return true;
                }
                return errorKeys.some(function (name) {
                    var error = _this.state.errors[name];
                    return typeof error === 'string' || error === true;
                });
            };

            _this.reset = function (inputName) {
                ...
                if (inputName) {
                    ...
                    newState.errors = Object.assign({}, errors, _defineProperty({}, inputName, ''));
                } else {
                    newState.values = Object.keys(values).reduce(function (accum, val) {
                        // eslint-disable-next-line
                        accum[val] = '';
                        return accum;
                    }, {});
                    newState.errors = Object.keys(errors).reduce(function (accum, val) {
                        // eslint-disable-next-line
                        accum[val] = '';
                        return accum;
                    }, {});
...
var _withValidator = __webpack_require__(14);
...
var makeMeSmart = function makeMeSmart(CustomComponent) {
    var SmartInput = function (_Validator) {
        ...
        _createClass(SmartInput, [{
            ...
            value: function componentWillMount() {
                ...
                smartFormContextValues.setValues(_defineProperty({}, this.props.name, valueToSet));
                smartFormContextValues.setDefaultValues(_defineProperty({}, this.props.name, valueToSet));
                smartFormContextValues.setErrors(_defineProperty({}, this.props.name, this.generateErrorMessage(valueToSet, true)));
            }
        }, {
            ...
            value: function render() {
                ...
                return _react2.default.createElement(CustomComponent, newProps);
            }
        }]);
    ...
    return function (props) {
        return _react2.default.createElement(
            _smartFormContext2.default.Consumer,
            null,
            function (context) {
                return _react2.default.createElement(SmartInput, _extends({}, props, { smartFormContextValues: context }));
            }
        );
    };
};
...
var withFormState = function withFormState(CustomButton) {
    var SmartButton = function (_PureComponent) {
        _inherits(SmartButton, _PureComponent);

        function SmartButton() {
            _classCallCheck(this, SmartButton);

            return _possibleConstructorReturn(this, (SmartButton.__proto__ || Object.getPrototypeOf(SmartButton)).apply(this, arguments));
        }
...
var _Submit = __webpack_require__(35);
...
var _smartForm = __webpack_require__(10);

var _smartForm2 = _interopRequireDefault(_smartForm);

var _smartInput = __webpack_require__(13);

var _smartInput2 = _interopRequireDefault(_smartInput);

var _withFormState = __webpack_require__(15);
...
var Form = function (_Component) {
    ...
    _createClass(Form, [{
        ...
        value: function render() {
            var _props = this.props,
                smartFormProp = _props.smartForm,
...
var _EyeIcon = __webpack_require__(31);

var _EyeIcon2 = _interopRequireDefault(_EyeIcon);

var _EyeOffIcon = __webpack_require__(32);
...
var Input = function (_Component) {
    ...
    function Input(props) {
        ...
        _this.togglePassword = function (e, r, value) {
            if (_this.props.type === 'password') {
                _this.setState({
                    type: value || (_this.state.type === 'text' ? 'password' : 'text')
                });
            }
        };
        ...
        _this.onFocus = function (e) {
            if (_this.props.focusedLabel) {
                _this.setState({
                    label: _this.props.focusedLabel
                });
            }
    ...
    _createClass(Input, [{
        ...
        value: function render() {
            ...
            var fieldComponent = this.props.wrapComponent ? _react2.default.createElement(
                'div',
                { className: inputProps.className,
                    onBlur: this.onBlur,
                    onFocus: this.onFocus },
                children
            ) : _react2.default.createElement(Field, inputProps);
            return _react2.default.createElement(
                InputOuter,
                ...
                children ? _react2.default.cloneElement(children, _extends({}, inputProps, {
                    ...
                    _react2.default.createElement(
                        Label,
                        { className: (0, _classnames2.default)({ required: inputOptions.required }, 'control-label') },
                        this.state.label
                    ),
                    _react2.default.createElement('i', { className: 'smart-form-bar' })
                ),
                _react2.default.createElement(
                    ErrorWrapper,
...
Input.propTypes = {
    ...
    onChange: _propTypes2.default.func,
    focusedLabel: _propTypes2.default.string,
    id: _propTypes2.default.string,
    value: _propTypes2.default.string,
    focused: _propTypes2.default.bool,
    onFocus: _propTypes2.default.func,
    ...
    errorMessage: _propTypes2.default.oneOfType([_propTypes2.default.string, _propTypes2.default.bool]),
    defaultValue: _propTypes2.default.string,
    inputRef: _propTypes2.default.func,
    debounce: _propTypes2.default.number,
    wrapComponent: _propTypes2.default.element,
    formProps: _propTypes2.default.shape({
        beforeSubmit: _propTypes2.default.bool,
        onValidate: _propTypes2.default.func,
...
var ButtonWrapper = _styledComponents2.default.button(_templateObject, function (props) {
    ...
    return props.disabled ? _colors2.default.shadesOfGray[3] : props.color;
}, function (props) {
...
var _templateObject = _taggedTemplateLiteral(['\n    animation: rotator ', 's linear infinite;\n    stroke: ', ';\n'], ['\n    animation: rotator ', 's linear infinite;\n    stroke: ', ';\n']),
    _templateObject2 = _taggedTemplateLiteral(['\n    @keyframes rotator {\n        0% {\n            transform: rotate(0deg);\n        }\n        100% {\n            transform: rotate(270deg);\n        }\n    }\n    .path {\n        stroke-dasharray: ', ';\n        stroke-dashoffset: 0;\n        transform-origin: center;\n        animation: dash ', 's ease-in-out infinite;\n    }\n    @keyframes dash {\n        0% {\n            stroke-dashoffset: ', ';\n        }\n        50% {\n            stroke-dashoffset: ', ';\n            transform: rotate(135deg);\n        }\n        100% {\n            stroke-dashoffset: ', ';\n            transform: rotate(450deg);\n        }\n    }\n'], ['\n    @keyframes rotator {\n        0% {\n            transform: rotate(0deg);\n        }\n        100% {\n            transform: rotate(270deg);\n        }\n    }\n    .path {\n        stroke-dasharray: ', ';\n        stroke-dashoffset: 0;\n        transform-origin: center;\n        animation: dash ', 's ease-in-out infinite;\n    }\n    @keyframes dash {\n        0% {\n            stroke-dashoffset: ', ';\n        }\n        50% {\n            stroke-dashoffset: ', ';\n            transform: rotate(135deg);\n        }\n        100% {\n            stroke-dashoffset: ', ';\n            transform: rotate(450deg);\n        }\n    }\n']);
...
var SVG = _styledComponents2.default.svg(_templateObject, duration, _colors2.default.main);

(0, _styledComponents.injectGlobal)(_templateObject2, offset, duration, offset, offset / 4, offset);

var Spinner = function Spinner(props) {
    var className = (0, _classnames2.default)(props.className, 'spinner');
    return _react2.default.createElement(
        'div',
        { className: className },
        _react2.default.createElement(
            SVG,
            { width: props.size + 'px', height: props.size + 'px', viewBox: '0 0 66 66', xmlns: 'http://www.w3.org/2000/svg' },
